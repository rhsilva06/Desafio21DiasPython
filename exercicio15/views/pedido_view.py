    ...
    def relatorio():
        ...
        if len(lista) == 0:
            ...
            for item in lista:
                ...
                print(f"{Util.CYELLOW2}Total do Pedido: {item.total}{Util.ENDC}")

                for p in item.itens:
                    print(
                        f"{Util.CYELLOW2}Nome produto: {p.nome_produto}{Util.ENDC}")
                    print(f"{Util.CYELLOW2}Preço: {p.preco}{Util.ENDC}")
        ...
        if(exibe_cabecalho == True):
            ...
            try:
                ...
                for produto in produtos:
                    ...
                    print(f"{Util.OKBLUE}Preço: {produto.preco}{Util.ENDC}")
                    print(
                        f"{Util.OKBLUE}---------------------------------------------------------------------------{Util.ENDC}")
